...
<template>
  <div class="w-screen h-screen flex items-center justify-center">
    <form @submit.prevent="onSubmit">
          ...
          <Select default-value="Royal Flush" v-bind="componentField">
            ...
            <SelectContent>
              <SelectGroup>
                ...
                <SelectItem value="Three of a Kind"> Três de Um Tipo </SelectItem>
                ...
                <SelectItem value="Four of a Kind"> Quatro de Um Tipo </SelectItem>
                <SelectItem value="Straight Flush"> Flush Sequência </SelectItem>
      ...
      <Button class="mt-4 border-2 w-full" type="submit"> Visualizar análise </Button>
    </form>
  </div>
</template>
...
const onSubmit = handleSubmit((values) => {
  ...
  if (pokerHands.includes(category as IPokerHand)) {
    router.push({ name: 'dashboard', query: { player_hand: category } })
  }
})
</script>
